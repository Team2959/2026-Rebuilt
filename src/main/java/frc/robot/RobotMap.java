...
public final class RobotMap {
    ...
    public static final int kShooterAngleMotorSparkMax = 36;
        // Kraken
    public static final int kShooterWheelkraken = 21;
    ...
    public static final int kStopFire = 7;
    public static final int kExtendIntake = 3;
    public static final int kRetractIntake = 10;
    ...
    public static final int kFeedShooter = 2;   // ToDo: assign real buttons!
    public static final int kReverseFeeder = 4; // ToDo: assign real buttons!
